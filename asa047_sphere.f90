subroutine nelmin ( fn, n, start, xmin, ynewlo, reqmin, step, konvge, kcount, &
  ...
  pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2)
...
!
  implicit none
    ...
    real*8, dimension( naxes1(1), naxes1(2) ), intent(in) :: imm1
    real*8, dimension( naxes2(1), naxes2(2) ), intent(in) :: imm2
...
!
  do
    ...
    p(1:n,n+1) = start(1:n)
    y(n+1) = fn ( start, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
    icount = icount + 1
!
...
!
    do j = 1, n
      ...
      p(1:n,j) = start(1:n)
      y(j) = fn ( start, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
      icount = icount + 1
      start(j) = x
    end do
!
...
!
      ...
      ystar = fn ( pstar, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
      icount = icount + 1
!
...
!
      if ( ystar < ylo ) then
        ...
        y2star = fn ( p2star, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
        icount = icount + 1
!
...
!
          if ( y(ihi) < y2star ) then
            ...
            do j = 1, n + 1
              ...
              xmin(1:n) = p(1:n,j)
              y(j) = fn ( xmin, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
              icount = icount + 1
            end do
...
!
    ...
    do i = 1, n
      del = step(i) * eps
      xmin(i) = xmin(i) + del
      z = fn ( xmin, pk1, pk2, naxes1, naxes2, im1, im2, imm1, imm2, elm1, azm1, elm2, azm2 )
      icount = icount + 1
      if ( z < ynewlo ) then
        ifault = 2
        exit
